...
public class OkHttpUtil {
    ...
    private static OkHttpUtil netRequest;
     ...
     * @param callBack
     */
    public void postJsonAsync(String url, String params, final DataCallBack callBack) {
        final Request request = buildJsonPostRequest(url, params);
        okHttpClient.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                deliverDataFailure(request, e, callBack);
